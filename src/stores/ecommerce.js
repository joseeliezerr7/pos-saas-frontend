...
export const useEcommerceStore = defineStore('ecommerce', () => {
  ...
  async function fetchSettings() {
    ...
    try {
      ...
      error.value = err.response?.data?.error?.message || 'Error al cargar configuración'
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function activateStore() {
    ...
    try {
      ...
      toast.error(err.response?.data?.error?.message || 'Error al activar tienda')
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function deactivateStore() {
    ...
    try {
      ...
      toast.error(err.response?.data?.error?.message || 'Error al desactivar tienda')
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function fetchDashboard() {
    ...
    try {
      ...
      error.value = err.response?.data?.error?.message || 'Error al cargar dashboard'
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function fetchProducts(params = {}) {
    ...
    try {
      ...
      error.value = err.response?.data?.error?.message || 'Error al cargar productos'
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function updateProductEcommerce(productId, data) {
    loading.value = true
    try {
      const response = await ecommerceService.updateProductEcommerce(productId, data)
  ...
  async function fetchOrders(params = {}) {
    ...
    try {
      ...
      error.value = err.response?.data?.error?.message || 'Error al cargar pedidos'
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function fetchOrder(id) {
    ...
    try {
      ...
      error.value = err.response?.data?.error?.message || 'Error al cargar pedido'
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function updateOrderStatus(id, data) {
    ...
    try {
      ...
      toast.error(err.response?.data?.error?.message || 'Error al actualizar estado')
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function fetchCustomers(params = {}) {
    ...
    try {
      ...
      error.value = err.response?.data?.error?.message || 'Error al cargar clientes'
      throw err
    } finally {
      loading.value = false
    }
    ...
    try {
      ...
      if (data.customer) {
        currentCustomer.value = {
          ...
          orders_count: data.customer.orders_count || data.stats?.total_orders || 0
        }
      } else {
      ...
      error.value = err.response?.data?.error?.message || 'Error al cargar cliente'
      throw err
    } finally {
      loading.value = false
    }

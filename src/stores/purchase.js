...
export const usePurchaseStore = defineStore("purchase", () => {
  ...
  async function updatePurchase(id, data) {
    ...
    try {
      ...
      const message =
        error.response?.data?.message || "Error al actualizar compra";
      const errors = error.response?.data?.errors;
  ...
  async function deletePurchase(id) {
    ...
    try {
      ...
      const message =
        error.response?.data?.message || "Error al eliminar compra";
      toast.error(message);
      return false;
    } finally {
      loading.value = false;
  ...
  async function receivePurchase(id, data) {
    ...
    try {
      ...
      const message =
        error.response?.data?.message || "Error al recibir compra";
      const errors = error.response?.data?.errors;

  ...
  actions: {
    ...
    async fetchBalanceSheet(params) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error al cargar el balance general";
        throw error;
      } finally {
        this.loading = false;
      }
    ...
    async fetchCashFlow(params) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error al cargar el flujo de caja";
        throw error;
      } finally {
        this.loading = false;
      }
    ...
    async fetchProductProfitability(params) {
      ...
      try {
        const response =
          await financialReportService.getProductProfitability(params);
        this.productProfitability = response.data;
        return response.data;
      } catch (error) {
        this.error =
          error.response?.data?.message ||
          "Error al cargar rentabilidad por producto";
        throw error;
      } finally {
        this.loading = false;
      }
    ...
    async fetchCategoryProfitability(params) {
      ...
      try {
        const response =
          await financialReportService.getCategoryProfitability(params);
        this.categoryProfitability = response.data;
        return response.data;
      } catch (error) {
        this.error =
          error.response?.data?.message ||
          "Error al cargar rentabilidad por categoría";
        throw error;
      } finally {
        this.loading = false;
      }
    ...
    async fetchBranchProfitability(params) {
      ...
      try {
        const response =
          await financialReportService.getBranchProfitability(params);
        this.branchProfitability = response.data;
        return response.data;
      } catch (error) {
        this.error =
          error.response?.data?.message ||
          "Error al cargar rentabilidad por sucursal";
        throw error;
      } finally {
        this.loading = false;
      }
    ...
    async fetchMonthlyComparison(params) {
      ...
      try {
        const response =
          await financialReportService.getMonthlyComparison(params);
        this.monthlyComparison = response.data;
        return response.data;
      } catch (error) {
        this.error =
          error.response?.data?.message ||
          "Error al cargar comparativo mensual";
        throw error;
      } finally {
        this.loading = false;
      }
    ...
    async fetchComprehensiveReport(params) {
      ...
      try {
        const response =
          await financialReportService.getComprehensiveReport(params);
        this.comprehensiveReport = response.data;
        return response.data;
      } catch (error) {
        this.error =
          error.response?.data?.message || "Error al cargar reporte completo";
        throw error;
      } finally {
        this.loading = false;
      }

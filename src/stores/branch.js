  ...
  actions: {
    async fetchBranches(params = {}) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error al cargar sucursales";
        throw error;
      } finally {
        this.loading = false;
      }
    ...
    async fetchBranch(id) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error al cargar sucursal";
        throw error;
      } finally {
        this.loading = false;
      }
    ...
    async updateBranch(id, data) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error al actualizar sucursal";
        throw error;
      } finally {
        this.loading = false;
      }
    ...
    async deleteBranch(id) {
      ...
      try {
        ...
        this.error =
          error.response?.data?.message || "Error al eliminar sucursal";
        throw error;
      } finally {
        this.loading = false;
      }

...
export const useGiftCardStore = defineStore("giftCard", () => {
  ...
  async function createGiftCard(data) {
    ...
    try {
      ...
      const message =
        error.response?.data?.message || "Error al crear gift card";
      toast.error(message);
      throw error;
    } finally {
      loading.value = false;
  ...
  async function checkBalance(code) {
    ...
    try {
      ...
      const message =
        error.response?.data?.message || "Error al verificar balance";
      toast.error(message);
      throw error;
    } finally {
      loading.value = false;
  ...
  async function redeemGiftCard(data) {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success(
          response.data.message || "Gift card canjeada exitosamente",
        );
        return response.data.data;
      }
    } catch (error) {
      const message =
        error.response?.data?.message || "Error al canjear gift card";
      toast.error(message);
      throw error;
    } finally {
      loading.value = false;
  ...
  async function addBalance(id, amount, description = null) {
    loading.value = true;
    try {
      const response = await giftCardService.addBalance(id, {
        amount,
        description,
      });
      if (response.data.success) {
      ...
      const message =
        error.response?.data?.message || "Error al agregar balance";
      toast.error(message);
      throw error;
    } finally {
      loading.value = false;
  ...
  async function voidGiftCard(id, reason) {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success(
          response.data.message || "Gift card anulada exitosamente",
        );
        await fetchGiftCards();
        return true;
      }
      ...
      const message =
        error.response?.data?.message || "Error al anular gift card";
      toast.error(message);
      throw error;
    } finally {
      loading.value = false;
  ...
  async function expireCards() {
    ...
    try {
      ...
      const message =
        error.response?.data?.message || "Error al expirar gift cards";
      toast.error(message);
      throw error;
    } finally {
      loading.value = false;

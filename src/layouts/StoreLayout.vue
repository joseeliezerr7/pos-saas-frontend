  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
      ...
      <div class="hidden md:block border-t border-gray-200 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            class="flex items-center gap-6 overflow-x-auto py-3 scrollbar-hide"
          >
            <router-link
              :to="`/store/${storeSlug}`"
          ...
          <div class="px-4 py-4 space-y-3">
            ...
            <div class="border-t border-gray-200 pt-3 mt-3">
              ...
              >
                ...
                <span
                  v-if="cartItemCount > 0"
                  class="bg-blue-600 text-white text-xs font-bold rounded-full px-2 py-0.5"
                >
                  {{ cartItemCount }}
                </span>
              </router-link>
    ...
    <footer class="bg-white border-t border-gray-200 mt-auto">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <p>
            &copy; {{ new Date().getFullYear() }} {{ store?.store_name }}. Todos
...
const loadCartCount = () => {
  ...
  const cart = JSON.parse(
    localStorage.getItem(`cart_${storeSlug.value}`) || "[]",
  );

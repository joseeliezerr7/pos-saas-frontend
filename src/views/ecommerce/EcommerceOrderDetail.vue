              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-500">
                    ...
                    <strong>#{{ order?.order_number }}</strong> a una venta en
                    el POS? Esta acción registrará la venta en el sistema.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-sm">
          ...
          <div class="p-6">
            ...
            <div class="space-y-4">
              <div
                v-for="note in order.internal_notes || []"
                :key="note.id"
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          ...
          <div class="space-y-3">
            <div>
              ...
              <p
                v-if="order.customer?.phone || order.customer_phone"
        ...
        >
          ...
          <div class="text-sm text-gray-600 space-y-1">
            ...
            <template v-else>
              ...
              <p v-if="order.shipping_address.address_line_1">
              ...
              <p v-if="order.shipping_address.city">
                {{ order.shipping_address.city
                  ...
                  >, {{ order.shipping_address.state }}</template
                >
              </p>
              <p v-if="order.shipping_address.postal_code">
                {{ order.shipping_address.postal_code }}
              </p>
              <p v-if="order.shipping_address.country">
...
const updateStatus = async () => {
  try {
    await ecommerceStore.updateOrderStatus(order.value.id, {

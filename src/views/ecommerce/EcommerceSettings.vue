  ...
  <div class="space-y-6">
    ...
    >
      ...
      <div class="flex items-center gap-3">
        ...
        <button v-else @click="toggleStoreStatus" class="btn-primary text-sm">
          Activar Tienda
        </button>
      </div>
    </div>
    ...
    <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm">
          ...
          <form @submit.prevent="saveSettings" class="p-6 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1"
                  >URL de la Tienda</label
                >
                <div class="flex items-center">
                  <span
                    class="px-4 py-2 bg-gray-100 border border-r-0 border-gray-300 rounded-l-lg text-gray-500 text-sm"
                  >
                    /store/
                  </span>
                  <input
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <div>
                    ...
                    >
                    <p class="text-sm text-gray-500">
                      El cliente transfiere a tu cuenta bancaria
                    </p>
                  </div>
                </label>
                <label
                ...
                >
                  ...
                  <div>
                    ...
                    >
                    <p class="text-sm text-gray-500">
                      Requiere configuracion de pasarela de pago
                    </p>
                  </div>
                </label>
              </div>
            ...
            <div>
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <div>
                    <span class="font-medium text-gray-900"
                      >Recoger en tienda</span
                    >
                    <p class="text-sm text-gray-500">
                      El cliente recoge su pedido en tu ubicacion
                    </p>
                  </div>
                </label>
                <label
                ...
                >
                  ...
                  <div>
                    ...
                    >
                    <p class="text-sm text-gray-500">
                      Entregas en la direccion del cliente
                    </p>
                  </div>
                </label>
              </div>
        ...
        <div class="bg-white rounded-lg shadow-sm">
          <div class="p-6 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-500 mt-1">
              Configuracion para clientes mayoristas
            </p>
          </div>
          <div class="p-6 space-y-4">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-sm text-gray-500">
                  Permite a clientes registrados acceder a precios mayoristas
                </p>
              </div>
              <button
            ...
            <div
              v-if="form.b2b_enabled"
              class="space-y-4 pt-4 border-t border-gray-200"
            >
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1"
                  >Minimo de Compra B2B</label
                >
                <div class="relative">
                  <span
                    class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500"
      ...
      <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          <h3 class="text-sm font-medium text-gray-500 uppercase mb-4">
            Vista Previa
          </h3>
          <div class="border border-gray-200 rounded-lg overflow-hidden">
            <div class="bg-gray-100 p-4 text-center">
              <div
                ...
                class="w-20 h-20 mx-auto mb-2 rounded-lg overflow-hidden"
              >
                <img
              ...
              <div
                v-else
                class="w-20 h-20 mx-auto mb-2 rounded-lg bg-gray-300 flex items-center justify-center"
              >
                <svg
              ...
              <p class="text-sm text-gray-500 truncate">
                {{ form.store_description || "Descripcion de la tienda" }}
              </p>
            </div>
          </div>
          <div class="mt-4">
            ...
            <code
              class="block p-2 bg-gray-100 rounded text-xs text-gray-700 break-all"
            >
              {{ storeUrl }}
            </code>
          </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          ...
          <div class="space-y-4">
            <div
              class="w-32 h-32 mx-auto rounded-lg overflow-hidden bg-gray-100 border-2 border-dashed border-gray-300"
            >
              <img
                v-if="settings?.logo_url"
                :src="settings.logo_url"
...
const populateForm = () => {
  ...
  form.store_description =
    settings.value.description || settings.value.store_description || "";
  ...
  form.shipping_methods =
    settings.value.shipping_options || settings.value.shipping_methods || [];
  form.shipping_cost = parseFloat(settings.value.shipping_cost) || 0;
  form.free_shipping_threshold =
    parseFloat(settings.value.free_shipping_threshold) || 0;

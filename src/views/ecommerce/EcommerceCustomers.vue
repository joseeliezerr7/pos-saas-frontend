  ...
  <div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        ...
        <p class="text-gray-600">Gestiona los clientes registrados en tu tienda online</p>
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-4">
      <div class="flex flex-col md:flex-row gap-4">
        ...
        <div class="flex gap-2">
          <select v-model="statusFilter" @change="loadCustomers" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
            <option value="">Todos los estados</option>
            <option value="active">Activo</option>
            <option value="pending">Pendiente</option>
            <option value="suspended">Suspendido</option>
          </select>
          <select v-model="typeFilter" @change="loadCustomers" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                    <span class="text-blue-600 font-medium">{{ getInitials(customer.name) }}</span>
                  </div>
                  <div class="ml-4">
...
const getTypeClass = (type) => {
  const classes = {
    retail: 'px-2 py-1 text-xs font-medium rounded-full bg-gray-100 text-gray-800',
    wholesale: 'px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800',

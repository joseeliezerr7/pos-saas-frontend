    ...
    >
      <div>
        ...
        <p class="text-gray-600">
          Gestiona que productos se muestran en tu tienda online
        </p>
      </div>
        ...
        <div class="relative">
          ...
          <div class="absolute top-2 left-2 flex flex-col gap-1">
            <span
              ...
              class="px-2 py-1 text-xs font-medium rounded-full bg-yellow-500 text-white"
            >
              Destacado
            </span>
            <span
              v-if="!product.show_in_ecommerce"
        ...
        <div class="p-4">
          ...
          <div class="mt-2 flex items-center justify-between">
            ...
            <span class="text-sm text-gray-500"
              >Stock: {{ getProductStock(product) }}</span
            >
          </div>
          <button
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="flex items-center">
              <input
                ...
                v-model="editForm.show_in_ecommerce"
                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              <label for="show_in_ecommerce" class="ml-2 text-sm text-gray-700"
                >Mostrar en tienda</label
              >
            </div>
            <div class="flex items-center">
              <input
...
const { products, categories, catalogPagination, loading } =
...
const saveProduct = async () => {
  saving.value = true;
  try {
    await ecommerceStore.updateProductEcommerce(editingProduct.value.id, {
      ...editForm,
    });

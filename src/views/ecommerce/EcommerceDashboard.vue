  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <router-link
          to="/ecommerce/orders?status=pending"
      ...
      <div class="flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          ...
          <p class="text-blue-100">
            Comienza a vender online en minutos. Configura tu tienda, agrega
            productos y empieza a recibir pedidos.
          </p>
        </div>
        <router-link
          to="/ecommerce/settings"
          class="btn bg-white text-blue-600 hover:bg-gray-100 whitespace-nowrap"
        >
          <svg
            class="w-5 h-5 mr-2"
            fill="none"

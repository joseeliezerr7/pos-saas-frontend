          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              >
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                  <div
                    v-if="supplier.credit_days > 0 || supplier.credit_limit > 0"
                  >
                    <div v-if="supplier.credit_days > 0">
                      {{ supplier.credit_days }} días
                    </div>
                    <div v-if="supplier.credit_limit > 0" class="text-xs">
                      Límite: L {{ formatMoney(supplier.credit_limit) }}
                    </div>
                  </div>

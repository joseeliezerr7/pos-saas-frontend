  ...
  <div class="super-admin-dashboard">
    <div class="mb-6">
      ...
      <p class="text-gray-600 mt-2">
        Gestiona todos los clientes y métricas del sistema
      </p>
    </div>
              ...
              <div class="flex items-center space-x-2">
                <div class="w-32 bg-gray-200 rounded-full h-2">
                  <div
                    ...
                    :style="{
                      width: `${getPlanPercentage(plan.active_subscriptions)}%`,
                    }"
                  ></div>
                </div>
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="text-center p-4 bg-gray-50 rounded-lg">
              <p class="text-2xl font-bold text-gray-600">
                {{ stats.subscriptions?.suspended || 0 }}
              </p>
...
const totalActiveSubscriptions = computed(() => {
  ...
  return stats.value.plans.reduce(
    (sum, plan) => sum + plan.active_subscriptions,
    0,
  );
});

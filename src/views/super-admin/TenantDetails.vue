    ...
    <div class="mb-6">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
          <button @click="editSubscription" class="btn-secondary">
            Editar Suscripción
          </button>
          <button
            @click="toggleStatus"
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="col-span-2">
              ...
              <p class="mt-1 text-sm text-gray-900">
                {{
                  statistics?.last_sale_date
                    ? formatDate(statistics.last_sale_date)
                    : "N/A"
                }}
              </p>
            </div>

<template>
  <div class="loyalty-program-container">
    ...
    <div class="page-header">
      <div>
        ...
        <p class="text-sm text-gray-500 mt-1">
          Configura el programa de puntos y niveles de tus clientes
        </p>
      </div>
    </div>

    <div
      v-if="loading && !program"
    ...
    >
      <div
        class="mx-auto w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mb-4"
      >
        <svg
      ...
      <h3 class="text-xl font-semibold text-gray-900 mb-2">
        No hay programa de lealtad configurado
      </h3>
      <p class="text-gray-600 mb-6">
        Crea un programa de puntos para tus clientes y aumenta su fidelidad.
      </p>
      <p class="text-sm text-gray-500 mb-6">
        El programa ya está preconfigurado con valores por defecto. Solo
        presiona "Guardar Programa" para activarlo.
      </p>
      <button
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <p class="text-xs text-gray-500 mt-1">
                Ej: 1 = 1 punto por cada L. gastado
              </p>
            </div>
        ...
        <div v-else class="space-y-3">
          ...
          >
            ...
            <div class="mt-3 grid grid-cols-2 gap-2 text-sm">
              ...
              <div class="text-gray-600">
                <span class="font-medium">Multiplicador:</span> x{{
        ...
        <div class="p-6">
          ...
          <form @submit.prevent="handleSaveTier" class="space-y-4">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">
                Beneficios
                <span class="text-xs text-gray-500">(uno por línea)</span>
              </label>
              <textarea

<template>
  <div class="space-y-6">
    ...
    <div class="card">
            ...
            >
              <td class="px-6 py-4">
                <div class="flex items-center">
                  <div
                    class="h-10 w-10 flex-shrink-0 rounded-full bg-primary-100 flex items-center justify-center"
                  >
              ...
              <td class="px-6 py-4">
                <span v-if="user.status === 'active'" class="badge-success"
                  >Activo</span
                >
                <span
      ...
      <!-- Pagination -->
      <div
        v-if="userStore.pagination.total > userStore.pagination.per_page"
        class="mt-4 flex justify-between items-center"
      >
        <div class="text-sm text-gray-500">
          Mostrando {{ userStore.users.length }} de
          {{ userStore.pagination.total }} usuarios
        </div>
    ...
    >
      <div
        class="bg-white rounded-lg max-w-2xl w-full p-6 my-8 max-h-[90vh] overflow-y-auto"
      >
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div>
            ...
            <div class="space-y-2 max-h-40 overflow-y-auto border rounded p-3">
              ...
              >
                ...
                <span v-if="role.description" class="text-xs text-gray-500"
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 mt-1">
              Los administradores pueden acceder a todas las sucursales. Los
              demás usuarios solo a la asignada.
            </p>
          </div>

        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
              <p class="text-base text-gray-900">
                {{ getModelName(selectedLog.auditable_type) }} #{{
          ...
          >
            <label class="block text-sm font-medium text-gray-500 mb-1"
              >Valores Anteriores</label
            >
            <pre
              class="text-sm text-gray-900 bg-red-50 p-3 rounded overflow-x-auto"
          ...
          >
            <label class="block text-sm font-medium text-gray-500 mb-1"
              >Valores Nuevos</label
            >
            <pre
              class="text-sm text-gray-900 bg-green-50 p-3 rounded overflow-x-auto"

  ...
  <div class="import-export p-6">
    ...
    <div class="mb-6">
      ...
      <p class="mt-2 text-gray-600">
        Importa y exporta datos masivamente usando archivos CSV
      </p>
    </div>
    ...
    <div v-show="activeTab === 'import'" class="space-y-6">
        ...
        <div class="flex items-start">
          ...
          <div class="ml-3 flex-1">
            ...
            <div class="mt-2 text-sm text-blue-700">
              <p>
                Para importar correctamente, descarga la plantilla Excel o CSV y
                llena los datos siguiendo el formato indicado. Recomendamos usar
      ...
      >
        ...
        <p class="text-sm text-gray-600 mt-2">
          El inventario se importará a esta sucursal
        </p>
      </div>
      ...
      <div class="bg-white p-6 rounded-lg shadow">
        ...
        >
          ...
          <p class="text-xs text-gray-500 mt-2">
            CSV o Excel (XLSX/XLS) hasta 10MB
          </p>
        </div>
      ...
      <div v-if="previewData" class="bg-white p-6 rounded-lg shadow">
        ...
        <div class="mb-4 text-sm text-gray-600">
          <p>
            Total de registros:
            <span class="font-semibold">{{ previewData.total_rows }}</span>
          </p>
          <p class="mt-1">
            Mostrando primeros {{ previewData.preview.length }} registros
          </p>
        </div>
        ...
        <div class="flex items-start">
          ...
          <div class="ml-3 flex-1">
            <h3
              ...
              :class="importResults.success ? 'text-green-800' : 'text-red-800'"
            >
              {{
            ...
            >
              ...
              <ul class="mt-2 text-xs text-red-700 space-y-1">
                <li
                  v-for="(error, idx) in importResults.errors.slice(0, 10)"
                  :key="idx"
                >
                  Fila {{ error.row }}:
    ...
    <div v-show="activeTab === 'export'" class="space-y-6">
      ...
      <div class="bg-white p-6 rounded-lg shadow">
        ...
        <p class="text-sm text-gray-600 mb-4">
          Descarga el listado completo de productos en formato CSV
        </p>
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            >
            <select
              v-model="exportProductFilters.category_id"
          ...
          <div>
            ...
            >
            <select
              v-model="exportProductFilters.is_active"
              class="w-full border border-gray-300 rounded-md px-3 py-2"
            >
      ...
      <div class="bg-white p-6 rounded-lg shadow">
        ...
        <p class="text-sm text-gray-600 mb-4">
          Descarga el listado completo de clientes en formato CSV
        </p>
      ...
      <div class="bg-white p-6 rounded-lg shadow">
        ...
        <p class="text-sm text-gray-600 mb-4">
          Descarga el reporte de ventas en formato CSV
        </p>
...
async function processImport() {
  ...
  try {
    ...
    if (importType.value === "products") {
      ...
      result = await importExportService.importInventory(
        selectedFile.value,
    ...
    if (result.success) {
      if (importType.value === "price-update") {
        toast.success(
          `Actualización completada: ${result.updated} precios actualizados`,
        );
      } else {
        toast.success(

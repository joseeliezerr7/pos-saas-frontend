<template>
  <div class="space-y-6">
    ...
    <div class="card">
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            >
              ...
              <td class="px-6 py-4">
                <span v-if="category.is_active" class="badge-success"
                  >Activa</span
                >
      ...
      <div
        v-if="
          categoryStore.pagination.total > categoryStore.pagination.per_page
        "
        class="mt-4 flex justify-between items-center"
      >
        <div class="text-sm text-gray-500">
          Mostrando {{ categoryStore.categories.length }} de
          {{ categoryStore.pagination.total }} categorías
        </div>

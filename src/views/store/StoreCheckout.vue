  ...
  <div>
    ...
    <div v-else-if="orderComplete" class="max-w-lg mx-auto text-center py-12">
      ...
      <p class="text-gray-600 mb-6">
        Tu pedido #{{ orderNumber }} ha sido recibido. Te contactaremos pronto
    ...
    <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              <p v-if="errors.customer_phone" class="text-red-500 text-sm mt-1">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm">
          ...
          <p v-if="errors.payment_method" class="text-red-500 text-sm mt-2">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm sticky top-24">
          ...
          <div class="border-t border-gray-200 pt-4 space-y-2">
            ...
            <div class="flex justify-between text-sm">
              ...
              <span
                class="font-medium"
                :class="{ 'text-green-600': shippingCost === 0 }"
              >
                {{
...
const shippingCost = computed(() => {
  ...
  if (
    props.store?.free_shipping_threshold &&
    subtotal.value >= props.store.free_shipping_threshold
  ) {
    return 0;
  }
...
const submitOrder = async () => {
  ...
  try {
    ...
    const response = await publicStoreService.processCheckout(
      props.storeSlug,
      orderData,
    );
    ...
    orderNumber.value =
      response.data.data?.order_number || response.data.order_number || "N/A";

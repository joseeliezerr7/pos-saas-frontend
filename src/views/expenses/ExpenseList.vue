    ...
    <div class="mb-6 flex items-center justify-between">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-600">
          Gestiona los gastos operativos de tu negocio
        </p>
      </div>
      <button
          ...
          <div class="ml-5 w-0 flex-1">
            <dl>
              ...
              <dd class="text-lg font-semibold text-gray-900">
                L {{ formatCurrency(statistics.total_expenses) }}
              </dd>
            </dl>
          </div>
        </div>
    ...
    <div class="mb-4 grid grid-cols-1 md:grid-cols-5 gap-4">
      ...
      <div>
        ...
        >
          ...
          <option
            v-for="branch in (branches || []).filter((b) => b && b.id)"
            :key="branch.id"
            :value="branch.id"
          >
            {{ branch.name }}
          ...
          >
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="text-sm font-semibold text-red-600">
                L {{ formatCurrency(expense.amount) }}
              </div>
            </td>
            <td
...
function openCreateModal() {
  form.value = {
    ...
    payment_method: "cash",
    branch_id:
      branches.value && branches.value.length > 0 ? branches.value[0].id : "",
    supplier_id: "",
    receipt_number: "",
    invoice_number: "",
    notes: "",

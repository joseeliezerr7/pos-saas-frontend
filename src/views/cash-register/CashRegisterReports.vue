    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
          ...
          >
          <select
            v-model="filters.cash_register_id"
            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
          >
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">
                L {{ formatMoney(reportData.total_sales || 0) }}
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">
                {{ reportData.closings_with_difference || 0 }}
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">
                ...
                {{
                  formatMoney(
                    reportData.total_openings > 0
                      ? reportData.total_sales / reportData.total_openings
                      : 0,
                  )
                }}
              </p>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr
                v-for="detail in reportData.details_by_register"
                :key="detail.cash_register_id"
              >
                <td
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <span
                    :class="
                      detail.closings_with_difference > 0
                        ? 'text-red-600'
                        : 'text-green-600'
                    "
      ...
      <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
          <h2 class="text-lg font-semibold text-gray-900">
            Usuarios con Más Aperturas
          </h2>
        </div>
        <div class="p-6">
          <div class="space-y-3">
            <div
              v-for="user in reportData.top_users"
              :key="user.user_id"
            ...
            >
              <div>
                ...
                <p class="text-xs text-gray-500">
                  {{ user.total_openings }} aperturas
                </p>
              </div>
              <div class="text-right">
                <p class="text-sm font-semibold text-gray-900">
                  L {{ formatMoney(user.total_sales) }}
                </p>

  ...
  <div class="financial-report p-6">
    <div class="mb-6">
      ...
      <p class="text-gray-600 mt-2">
        Estado de Resultados, Balance General, Flujo de Caja y Análisis de
        Rentabilidad
      </p>
    </div>
      ...
      <div class="p-6">
          ...
          <div v-if="profitAndLoss">
            <div class="mb-6">
              ...
              <p class="text-sm text-gray-600">
                Período: {{ formatDate(profitAndLoss.period?.start_date) }} -
                {{ formatDate(profitAndLoss.period?.end_date) }}
              </p>
            </div>

            <!-- Revenue Section -->
            <div
              class="bg-green-50 border border-green-200 rounded-lg p-6 mb-4"
            >
              ...
              <div class="space-y-2">
                <div class="flex justify-between">
                  ...
                  <span class="font-semibold"
                    >L
                    {{
                      formatCurrency(profitAndLoss.revenue?.total_sales)
                    }}</span
                  >
                </div>
                ...
                <div class="flex justify-between text-sm text-gray-600">
                  ...
                  <span
                    >L
                    {{
                      formatCurrency(profitAndLoss.revenue?.average_sale)
                    }}</span
                  >
                </div>
              </div>
            ...
            <!-- Cost of Sales -->
            <div
              class="bg-orange-50 border border-orange-200 rounded-lg p-6 mb-4"
            >
              <div class="flex justify-between items-center">
                ...
                <span class="text-xl font-bold text-orange-900"
                  >L {{ formatCurrency(profitAndLoss.cost_of_sales) }}</span
                >
              </div>
            </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-4">
              ...
              <div class="flex justify-between items-center">
                <span class="text-2xl font-bold text-blue-900"
                  >L
                  {{ formatCurrency(profitAndLoss.gross_profit?.amount) }}</span
                >
                <span class="text-lg font-semibold text-blue-700"
                  >{{ profitAndLoss.gross_profit?.margin_percentage }}%
                  margen</span
                >
              </div>
            </div>
            ...
            <div class="bg-red-50 border border-red-200 rounded-lg p-6 mb-4">
              ...
              <div class="space-y-2 mb-3">
                <div
                  v-for="(amount, category) in profitAndLoss.operating_expenses
                    ?.by_category"
                  :key="category"
              ...
              <div class="border-t border-red-300 pt-3 flex justify-between">
                ...
                <span class="font-bold text-lg"
                  >L
                  {{
                    formatCurrency(profitAndLoss.operating_expenses?.total)
                  }}</span
                >
              </div>
            </div>
            ...
            <!-- Operating Profit -->
            <div
              class="bg-purple-50 border border-purple-200 rounded-lg p-6 mb-4"
            >
              <div class="flex justify-between items-center">
                ...
                <span class="text-xl font-bold text-purple-900"
                  >L {{ formatCurrency(profitAndLoss.operating_profit) }}</span
                >
              </div>
            </div>
            ...
            <!-- Net Profit -->
            <div
              class="bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-lg p-6"
            >
              <h4 class="text-xl font-semibold mb-3">Ganancia Neta</h4>
              <div class="flex justify-between items-center">
                <span class="text-3xl font-bold"
                  >L
                  {{ formatCurrency(profitAndLoss.net_profit?.amount) }}</span
                >
                <span class="text-xl font-semibold"
                  >{{ profitAndLoss.net_profit?.margin_percentage }}%
                  margen</span
                >
              </div>
            </div>
                  ...
                  <div class="space-y-3">
                    ...
                    <div class="border-t border-blue-300 pt-3">
                      <div class="flex justify-between font-bold text-blue-900">
                        ...
                        <span
                          >L
                          {{ formatCurrency(balanceSheet.assets?.total) }}</span
                        >
                      </div>
                    </div>
                  </div>
              ...
              <div class="space-y-6">
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                  ...
                  <div class="flex justify-between font-bold text-green-900">
                    ...
                    <span
                      >L {{ formatCurrency(balanceSheet.equity?.total) }}</span
                    >
                  </div>
                </div>
              </div>
        ...
        <div v-show="activeTab === 'cash-flow'">
          <div v-if="cashFlow">
            <div class="mb-6">
              ...
              <p class="text-sm text-gray-600">
                Período: {{ formatDate(cashFlow.period?.start_date) }} -
              ...
              <div class="space-y-2">
                <div class="flex justify-between">
                  ...
                  <span class="font-semibold"
                    ...
                    {{
                      formatCurrency(
                        cashFlow.operating_activities?.cash_inflows
                          ?.direct_sales,
                      )
                    }}</span
                  >
                ...
                <div
                  class="border-t border-green-300 pt-2 flex justify-between font-bold text-green-900"
                >
                  ...
                  <span
                    ...
                    {{
                      formatCurrency(
                        cashFlow.operating_activities?.cash_inflows?.total,
                      )
                    }}</span
                  >
                </div>
              ...
              <div class="space-y-2">
                <div class="flex justify-between">
                  ...
                  <span
                    ...
                    {{
                      formatCurrency(
                        cashFlow.operating_activities?.cash_outflows?.purchases,
                      )
                    }}</span
                  >
                </div>
                <div class="flex justify-between">
                  ...
                  <span
                    ...
                    {{
                      formatCurrency(
                        cashFlow.operating_activities?.cash_outflows?.expenses,
                      )
                    }}</span
                  >
                </div>
                <div
                  v-if="
                    cashFlow.operating_activities?.cash_outflows
                      ?.supplier_payments
                  "
                  class="flex justify-between"
                >
                ...
                <div
                  class="border-t border-red-300 pt-2 flex justify-between font-bold text-red-900"
                >
                  ...
                  <span
                    ...
                    {{
                      formatCurrency(
                        cashFlow.operating_activities?.cash_outflows?.total,
                      )
                    }}</span
                  >
                </div>
            ...
            <!-- Net Cash Flow -->
            <div
              class="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg p-6"
            >
              <h4 class="text-xl font-semibold mb-3">Flujo Neto de Efectivo</h4>
              <div class="text-3xl font-bold">
                L
                {{
                  formatCurrency(cashFlow.operating_activities?.net_cash_flow)
                }}
              </div>
            </div>
          </div>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="product in productProfitability" :key="product.id">
                    ...
                    <td
                      class="px-6 py-4 text-sm text-right text-green-600 font-semibold"
                    >
                      L {{ formatCurrency(product.revenue) }}
                    </td>
                    <td class="px-6 py-4 text-sm text-right text-orange-600">
                      L {{ formatCurrency(product.cost) }}
                    </td>
                    <td
                      class="px-6 py-4 text-sm text-right text-blue-600 font-bold"
                    >
                      L {{ formatCurrency(product.profit) }}
                    </td>
                    <td class="px-6 py-4 text-sm text-right">
                      <span
                        class="px-2 py-1 rounded-full text-xs font-semibold"
                        :class="
                          getProfitabilityClass(product.margin_percentage)
                        "
                      >
        ...
        <div v-show="activeTab === 'category-profitability'">
          <div v-if="categoryProfitability && categoryProfitability.length > 0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div
                v-for="category in categoryProfitability"
                :key="category.id"
                ...
                <div class="space-y-2 text-sm">
                  ...
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-green-600"
                      >L {{ formatCurrency(category.revenue) }}</span
                    >
                  </div>
                  <div class="flex justify-between">
                    <span class="text-gray-600">Costo</span>
                    <span class="font-semibold text-orange-600"
                      >L {{ formatCurrency(category.cost) }}</span
                    >
                  </div>
                  <div class="border-t pt-2 flex justify-between">
                    <span class="text-gray-900 font-semibold">Ganancia</span>
                    <span class="font-bold text-blue-600"
                      >L {{ formatCurrency(category.profit) }}</span
                    >
                  </div>
                  <div class="flex justify-between items-center">
                    ...
                    <span
                      ...
                      :class="getProfitabilityClass(category.margin_percentage)"
                    >
        ...
        <div v-show="activeTab === 'branch-profitability'">
          <div v-if="branchProfitability && branchProfitability.length > 0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div
                v-for="branch in branchProfitability"
                :key="branch.id"
                class="bg-white border-2 border-gray-200 rounded-lg p-6 hover:border-blue-500 transition-colors"
              >
                ...
                <div class="space-y-3">
                  ...
                  <div class="flex justify-between items-center">
                    ...
                    <span class="text-lg font-bold text-green-600"
                      >L {{ formatCurrency(branch.revenue) }}</span
                    >
                  </div>
                  <div class="flex justify-between items-center">
                    <span class="text-gray-600">Costo</span>
                    <span class="font-semibold text-orange-600"
                      >L {{ formatCurrency(branch.cost) }}</span
                    >
                  </div>
                  <div
                  ...
                  >
                    ...
                    <span class="text-xl font-bold text-blue-600"
                      >L {{ formatCurrency(branch.profit) }}</span
                    >
                  </div>
                  <div class="flex justify-between items-center">
                    <span class="text-gray-600">Margen</span>
                    <span
                      ...
                      :class="getProfitabilityClass(branch.margin_percentage)"
                    >
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="month in monthlyComparison" :key="month.month">
                    ...
                    <td
                      class="px-4 py-4 text-sm text-right text-green-600 font-semibold"
                    >
                      L {{ formatCurrency(month.revenue) }}
                    </td>
                    <td class="px-4 py-4 text-sm text-right text-orange-600">
                      L {{ formatCurrency(month.cost_of_sales) }}
                    </td>
                    <td
                      class="px-4 py-4 text-sm text-right text-blue-600 font-semibold"
                    >
                      L {{ formatCurrency(month.gross_profit) }}
                    </td>
                    <td class="px-4 py-4 text-sm text-right text-red-600">
                      L {{ formatCurrency(month.expenses) }}
                    </td>
                    <td
                      class="px-4 py-4 text-sm text-right font-bold"
                      :class="
...
const productProfitability = computed(
  () => financialReportStore.productProfitability,
);
const categoryProfitability = computed(
  () => financialReportStore.categoryProfitability,
);
const branchProfitability = computed(
  () => financialReportStore.branchProfitability,
);
const monthlyComparison = computed(
  () => financialReportStore.monthlyComparison,
);

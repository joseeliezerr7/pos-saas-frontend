<template>
  <div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
      ...
      <router-link to="/quotations" class="btn-secondary"> Volver </router-link>
    </div>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <div class="card">
        ...
        <div
          ...
          class="mt-4 border rounded-lg overflow-hidden max-h-60 overflow-y-auto"
        >
          <div
...
const totals = computed(() => {
  ...
  const discount = form.value.items.reduce(

    ...
    <div class="flex justify-between items-center mb-6">
      <div>
        ...
        <p class="text-gray-600 mt-1">
          Registro y seguimiento de pagos de clientes
        </p>
      </div>
      <button
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  >
                    <td class="px-4 py-2 text-sm text-gray-900">
                      {{ allocation.credit_sale?.sale?.sale_number }}
                    </td>
                    <td class="px-4 py-2 text-sm text-right">
                      L
                      {{
                        formatCurrency(allocation.credit_sale?.original_amount)
                      }}
                    </td>
                    <td
                    ...
                    <td class="px-4 py-2 text-sm text-right">
                      L
                      {{ formatCurrency(allocation.credit_sale?.balance_due) }}
                    </td>
                  </tr>
                </tbody>
              </table>

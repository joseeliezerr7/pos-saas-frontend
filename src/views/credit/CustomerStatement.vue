  ...
  <div class="customer-statement-page">
    ...
    <div class="flex justify-between items-center mb-6">
      <div>
        ...
        <p v-if="customerData" class="text-gray-600 mt-1">
          {{ customerData.name }}
        </p>
      </div>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-blue-700">
              L {{ formatCurrency(customerData?.credit_limit || 0) }}
            </p>
          </div>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-green-700">
              L {{ formatCurrency(availableCredit) }}
            </p>
          </div>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-red-700">
              L {{ formatCurrency(customerData?.current_balance || 0) }}
            </p>
          </div>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-purple-700">
              {{ customerData?.credit_days || 30 }} días
            </p>
          </div>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          >
            ...
            >
              ...
              <span v-if="transaction.balance < 0" class="text-xs ml-1"
                >(A favor)</span
              >
            </td>
          </tr>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          ...
          <p class="text-xl font-semibold text-gray-900">
            L {{ formatCurrency(statementSummary.opening_balance || 0) }}
          </p>
        </div>
        <div>
      ...
      <div class="mt-4 pt-4 border-t border-gray-200">
        <div class="flex justify-between items-center">
          ...
          <p
            ...
            :class="finalBalance >= 0 ? 'text-red-600' : 'text-green-600'"
          >
            L {{ formatCurrency(Math.abs(finalBalance)) }}
            <span v-if="finalBalance < 0" class="text-sm ml-2"
              >(A favor del cliente)</span
            >
          </p>
        </div>
      </div>
        ...
        <div class="overflow-y-auto max-h-[calc(90vh-80px)] bg-gray-100 p-6">
          ...
          >
            ...
            <div class="mb-4 text-sm">
              <p>
                <strong>Período:</strong> {{ formatDate(filters.start_date) }} -
            ...
            <table class="w-full text-sm mb-6">
              ...
              <tbody>
                <tr
                  v-if="statementSummary.opening_balance > 0"
                ...
                >
                  ...
                  <td class="py-2 px-3 text-right font-semibold">
                    L {{ formatCurrency(statementSummary.opening_balance) }}
                  </td>
                </tr>
                <tr
                  v-for="(transaction, index) in transactions"
                ...
                >
                  ...
                  <td class="py-2 px-3 text-gray-600">
                    <span
                      v-if="transaction.type === 'sale'"
                      class="inline-block px-2 py-0.5 bg-red-100 text-red-800 text-xs rounded"
                      >Venta</span
                    >
                    <span
                      v-else
                  ...
                  <td class="py-2 px-3 text-right font-semibold text-red-600">
                    {{
                      transaction.charge > 0
                        ? "L " + formatCurrency(transaction.charge)
                        : "-"
                    }}
                  </td>
                  <td class="py-2 px-3 text-right font-semibold text-green-600">
                    {{
                      transaction.payment > 0
                        ? "L " + formatCurrency(transaction.payment)
                        : "-"
                    }}
                  </td>
                  <td class="py-2 px-3 text-right font-semibold">
              ...
              <tfoot>
                <tr class="bg-gray-100 font-bold">
                  ...
                  <td class="py-3 px-3 text-right text-red-600">
                    L {{ formatCurrency(totalCharges) }}
                  </td>
              ...
              <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <p class="text-xl font-bold">
                    L
                    {{ formatCurrency(statementSummary.opening_balance || 0) }}
                  </p>
                </div>
                <div class="text-right">
            ...
            <!-- Footer -->
            <div
              class="mt-8 pt-4 border-t border-gray-300 text-xs text-gray-600 text-center"
            >
              <p>
                Este es un documento generado electrónicamente y no requiere
                firma
              </p>
              <p class="mt-1">
                {{ companyData.name }} - {{ companyData.phone }} -
                {{ companyData.email }}
              </p>
              <p class="mt-1">
                Generado el {{ formatDate(new Date()) }} a las
                {{ formatTime(new Date()) }}
              </p>
            </div>
          </div>

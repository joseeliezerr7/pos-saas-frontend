    ...
    <div class="mb-6 flex justify-between items-center">
      <div>
        ...
        <p class="text-gray-600 mt-1">
          Gestión de ajustes y conteos de inventario
        </p>
      </div>
      <router-link
          ...
          >
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="text-sm font-semibold text-gray-900">
                L {{ formatMoney(adjustment.total_adjustment) }}
              </div>
            </td>
            <td class="px-6 py-4 whitespace-nowrap">
              <span
...
function confirmApprove(adjustment) {
  if (
    confirm(
      `¿Aprobar el ajuste ${adjustment.adjustment_number}? Esto actualizará el inventario.`,
    )
  ) {

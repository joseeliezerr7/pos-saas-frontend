    ...
    <div class="mb-6 flex justify-between items-center">
      <div>
        ...
        <p class="text-gray-600 mt-2">
          Gestione las promociones y descuentos de su negocio
        </p>
      </div>
      <button
        v-if="can('create_promotions')"
      ...
      <div class="p-6">
        ...
        <div v-else-if="promotions.length === 0" class="text-center py-12">
          ...
          <p class="mt-1 text-sm text-gray-500">
            Comience agregando una nueva promoción.
          </p>
        </div>
              ...
              >
                <td class="px-6 py-4">
                  <div>
                    ...
                    <div class="text-xs text-gray-500">
                      <span
                        v-if="promotion.code"
                        class="inline-flex items-center px-2 py-0.5 rounded bg-purple-100 text-purple-800 font-mono"
                      >
                        {{ promotion.code }}
                      </span>
                ...
                >
                  ...
                  <button
                    ...
                    @click="viewStats(promotion)"
                    class="text-purple-600 hover:text-purple-800 mr-3"
                  >
                    Stats
                  </button>
                  <button
                    v-if="can('delete_promotions')"
        ...
        <div
          ...
          class="mt-4 flex justify-between items-center border-t pt-4"
        >
          <div class="text-sm text-gray-700">
            Mostrando {{ promotions.length }} de
            {{ pagination.total }} promociones
          </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                  Opcional. Deje vacío para promoción automática
                </p>
              </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <input
                  ...
                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  :placeholder="
                    form.type === 'percentage' ? 'Ej: 20' : 'Ej: 50.00'
                  "
                />
              </div>
      ...
      <div class="bg-white rounded-lg max-w-2xl w-full p-6">
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-xl font-bold">
            Estadísticas: {{ selectedPromotion?.name }}
          </h2>
          <button
        ...
        <div v-else-if="stats" class="space-y-4">
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="bg-purple-50 p-4 rounded-lg">
              ...
              <div class="text-2xl font-bold text-purple-600">
                ${{ stats.average_discount?.toFixed(2) || "0.00" }}
              </div>
            </div>
          ...
          <div
            v-if="stats.top_customers && stats.top_customers.length > 0"
            class="mt-4"
          >
            ...
            <div class="space-y-2">
              ...
              >
                <span>{{
                  customer.customer_name || `Cliente #${customer.customer_id}`
                }}</span>
                <span class="text-sm text-gray-600"
                  >{{ customer.uses }} usos</span
                >
              </div>
            </div>
          </div>
...
function openEditModal(promotion) {
  ...
  applicableIdsInput.value = promotion.applicable_ids
    ? promotion.applicable_ids.join(",")
    : "";
  form.value = {
    name: promotion.name,
...
async function handleSubmit() {
  ...
  try {
    ...
    if (form.value.applicable_to !== "all" && applicableIdsInput.value) {
      form.value.applicable_ids = applicableIdsInput.value
        .split(",")
    ...
    if (editingPromotion.value) {
      await promotionStore.updatePromotion(

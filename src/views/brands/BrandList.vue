    ...
    <div class="mb-6 flex justify-between items-center">
      <div>
        ...
        <p class="text-gray-600 mt-2">
          Gestione el catálogo de marcas de productos
        </p>
      </div>
      <button
                  ...
                  <div class="flex items-center">
                    <div v-if="brand.logo" class="flex-shrink-0 h-10 w-10 mr-3">
                      <img
                        :src="brand.logo"
                        :alt="brand.name"
                        class="h-10 w-10 rounded object-contain bg-gray-100"
                      />
                    </div>
                    <div
                      v-else
                      class="flex-shrink-0 h-10 w-10 mr-3 bg-gray-200 rounded flex items-center justify-center"
                    >
                      <svg
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div>
            ...
            <p class="mt-1 text-xs text-gray-500">
              Ingrese la URL completa del logo de la marca
            </p>
          </div>
          ...
          <div v-if="form.logo" class="flex items-center space-x-3">
            ...
            <img
              :src="form.logo"
              alt="Logo preview"
              class="h-16 w-16 object-contain bg-gray-100 rounded"
            />
          </div>

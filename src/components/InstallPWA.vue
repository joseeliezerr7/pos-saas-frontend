<template>
  ...
  <transition name="slide-up">
    ...
    >
      <div
        class="bg-white rounded-lg shadow-2xl border-2 border-primary-500 p-4"
      >
  ...
  <transition name="slide-up">
    <div v-if="showUpdatePrompt" class="fixed bottom-6 left-6 z-50 max-w-sm">
      <div
        class="bg-green-50 rounded-lg shadow-lg border-2 border-green-500 p-4"
      >
        <div class="flex items-start space-x-3">
          <div class="flex-shrink-0">
            <svg
    ...
    <div v-if="!isOnline" class="fixed top-0 left-0 right-0 z-50">
      ...
      >
        <div class="flex items-center justify-center space-x-2">
          ...
          <span
            >Modo offline - Los cambios se sincronizarán cuando vuelva la
            conexión</span
          >
        </div>
      </div>
